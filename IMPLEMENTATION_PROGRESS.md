...
| --- | --------------------------------------------------------------- | ------------------------------------- | ------------------ | --------------------------------- | ------- | -- | ------------ | ------------- | ------------------------------------------------------------------------------ |
| 001 | Project governance and baseline                                 | Phase 0                               | None               | `feat/001-project-baseline`       | IN_PROGRESS | —  | —            | Version inventory, docs search, durable rule | DDD rule recorded through Laravel Boost                              |
...
Checklist: Manifest reconciled; version inventory and documentation searches completed; DDD rule recorded through Laravel Boost.
