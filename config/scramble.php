...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Versioned API for the Next-Gen Financial Tracker. Protected endpoints use a Laravel Sanctum bearer token. Every mutation requires an Idempotency-Key, and versioned resources require If-Match where documented.',
    ],

    'ui' => [
        'title' => 'Next-Gen Financial Tracker API',
    ],
