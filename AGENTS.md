...
- This application uses Pest for testing. All tests must use Pest closure syntax. Use `php artisan make:test --pest {name}` to create a new test.
- If you see a class-style test, convert it to Pest.
