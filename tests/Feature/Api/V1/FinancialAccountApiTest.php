...
test('owner can create archive and restore an account with idempotency and versions', function (): void {
...
test('account currency cannot change after posted history lock exists', function (): void {
    $user = User::factory()->create();
...
test('another user cannot view an account', function (): void {
