...
class RuntimeCheck extends Command
{
    ...
    /**
     * @return array{app_key: mixed, app_debug: mixed, api_docs_enabled: mixed, database_default: mixed, cache_default: mixed, queue_default: mixed, filesystem_default: mixed, minio: array<string, mixed>, release: array<string, mixed>, logging: array<string, mixed>, receipts: array<string, mixed>}
     */
