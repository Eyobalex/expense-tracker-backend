...
class StoreFinancialTransactionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category_id' => ['nullable', 'uuid'], 'related_transaction_id' => ['nullable', 'uuid'],
            ...
            'state' => ['prohibited'], 'source' => ['prohibited'], 'adjustment_subtype' => ['nullable', 'in:balance_correction,financial_system_adjustment'],
            'adjustment_direction' => ['nullable', 'in:debit,credit'], 'reason' => ['nullable', 'string', 'max:500'],
            ...
            'rounding_mode' => ['nullable', 'in:HALF_UP,HALF_EVEN,DOWN,UP,FLOOR,CEILING'], 'description' => ['nullable', 'string', 'max:500'],
            'splits' => ['nullable', 'array'], 'splits.*.category_id' => ['required', 'uuid'], 'splits.*.amount_minor_units' => ['required', 'integer', 'min:1'],
